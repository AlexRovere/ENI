 ...
 */
final class Version20250213123036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wish RENAME COLUMN label TO description');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wish RENAME COLUMN description TO label');
    }
}
