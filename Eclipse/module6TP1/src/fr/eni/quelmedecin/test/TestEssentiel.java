...
public class TestEssentiel {
	...
	public static void main(String[] args) {
		...
		Collections.sort(liste, Comparator.comparing(MedecinSpecialiste::getTarif));
		 ...
		 */
		Collections.sort(liste, Comparator.comparing(MedecinSpecialiste::getTarif).reversed());
